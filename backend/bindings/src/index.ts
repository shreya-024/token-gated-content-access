...
export const networks = {
  testnet: {
    ...
    contractId: "CDLLDWLXMY462ICLUCBOBSGYAZFQJCIGZORW4V2X52ULHMUI5XB7PMIT",
  }
} as const
...
export interface Client {
   ...
   */
  has_access: ({who}: {who: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAFZ3JhbnQAAAAAAAABAAAAAAAAAAN3aG8AAAAAEwAAAAA=",
        "AAAAAAAAAAAAAAAGcmV2b2tlAAAAAAABAAAAAAAAAAN3aG8AAAAAEwAAAAA=",
        "AAAAAAAAAAAAAAAKaGFzX2FjY2VzcwAAAAAAAQAAAAAAAAADd2hvAAAAABMAAAABAAAAAQ==",
